...
In this directory resiudes exercies programs written in python and c
as part of Alx's second semester course
The files of interest in this folder mainly are the onces done to practice
variables, printing, and running python scripts
