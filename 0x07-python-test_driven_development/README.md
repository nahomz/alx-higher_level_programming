...
In this project, I learned one of the interesting thing in 
software development, testing. I learned test-driven development 
in python using `docstring` and `unittest`.
