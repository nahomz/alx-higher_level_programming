...
In this folder there are exercises done as part of the holberton program
to learn object-oriented programming in Python. I have learned about 
class methods, static methods, class vs instance attributes, special methods like
`__str__` and `__repr__` and more.
