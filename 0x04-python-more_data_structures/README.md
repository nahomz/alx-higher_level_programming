...
In this folder, there are exercises answers done on
sets and dictionaries in Python, using different builtin
methods like `lambda`, `map`, `filter`, and `reduce` methods.
